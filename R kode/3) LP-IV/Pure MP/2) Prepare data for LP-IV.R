...
#########################################################################
shock <- readRDS(file.path("Data","LP-IV","PureMP","1.stage_instrument.rds"))
...
output_dir <- file.path("Data", "LP-IV", "PureMP")

# Save final dataset
saveRDS(data, file = file.path(output_dir, "input_data.rds"))
saveRDS(shock, file = file.path(output_dir, "PureMP_shock.rds"))
